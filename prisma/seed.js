...
async function main() {
    ...
    const permissionsData = [
        { name: 'assign_permissions', description: 'Allows assigning/removing permissions to roles' },
        { name: 'create_dealers', description: 'Allows creating new dealers' },
        { name: 'delete_dealers', description: 'Allows soft-deleting dealers' },
        { name: 'delete_permissions', description: 'Allows soft-deleting permissions' },
        { name: 'delete_roles', description: 'Allows soft-deleting roles' },
        { name: 'generate_pdfs', description: 'Allows generating PDFs from images' },
        ...
        { name: 'manage_dealer_billing', description: 'Allows managing dealer billing addresses' },
        { name: 'manage_dealer_contracts', description: 'Allows managing dealer contracts' },
        { name: 'manage_dealer_credit', description: 'Allows managing dealer credit details' },
        { name: 'manage_dealer_documents', description: 'Allows managing dealer documents' },
        { name: 'manage_dealer_salepoints', description: 'Allows managing dealer sale points' },
        { name: 'manage_notifications', description: 'Allows sending notifications' },
        ...
        { name: 'Manage Shop', description: 'Allows managing shop entities (categories, products, brands)' }, // Keep exact string from code
        ...
        { name: 'view_activation_analytics', description: 'Allows viewing activation analytics' },
        { name: 'view_all_notifications', description: 'Allows viewing all notifications' },
        ...
        { name: 'view_dealer_analytics', description: 'Allows viewing dealer analytics' },
        { name: 'view_dealer_billing', description: 'Allows viewing dealer billing addresses' },
        { name: 'view_dealer_contracts', description: 'Allows viewing dealer contracts' },
        { name: 'view_dealer_credit', description: 'Allows viewing dealer credit details' },
        { name: 'view_dealer_documents', description: 'Allows viewing dealer documents' },
        { name: 'view_dealers', description: 'Allows viewing dealers' },
        { name: 'view_dealer_salepoints', description: 'Allows viewing dealer sale points' },
        { name: 'view_permissions', description: 'Allows viewing permissions' }, // Can be covered by manage_permissions
        { name: 'view_product_analytics', description: 'Allows viewing product analytics' },
        { name: 'view_revenue_forecast', description: 'Allows viewing revenue forecast' },
        { name: 'view_roles', description: 'Allows viewing roles' }, // Can be covered by manage_roles
        { name: 'view_sales_analytics', description: 'Allows viewing sales analytics' },
        { name: 'view_user_analytics', description: 'Allows viewing user analytics' },
        ...
        { name: 'view_sim_serials', description: 'Allows viewing SIM serial numbers' },
        { name: 'manage_sim_serials', description: 'Allows managing SIM serial numbers' },
        { name: 'view_serial_numbers', description: 'Allows viewing Serial Numbers' },
        { name: 'manage_serial_numbers', description: 'Allows managing Serial Numbers' },
        ...
        { name: 'manage_tariffs', description: 'Allows managing Tariffs and Tariff Options' }, // Added based on activation routes
    ...
    const rolesWithPermissions = {
        ...
        'Admin': [
            ...
            'manage_roles', 'view_roles', 'assign_permissions',
            'manage_permissions', 'view_permissions',
            'manage_workflows', 'view_workflows', // Global workflow management
            'manage_notifications', 'view_all_notifications',
            'upload_assets', 'view_assets', 'manage_assets', // Global asset management
            'send_emails', 'generate_pdfs', // Utility
            'Manage Shop', // Global shop management
            'view_sales_analytics', 'view_product_analytics', 'view_user_analytics',
            'view_dealer_analytics', 'view_activation_analytics', 'view_revenue_forecast', // Global analytics
            ...
            'view_tariffs', 'manage_tariffs', // Can manage tariffs
            'view_companies', 'manage_companies', // Can manage companies (assuming these permissions)
            'view_carts', 'manage_carts', // Can manage carts globally (assuming these permissions)

        ],
        'SalesManager': [
            'Manage Shop', // Global shop management
            'view_dealers', 'create_dealers', 'update_dealers', 'delete_dealers', // Global dealer management (soft delete)
            'view_dealer_billing', 'manage_dealer_billing', // Global
            'view_dealer_contracts', 'manage_dealer_contracts', // Global
            'view_dealer_credit', 'manage_dealer_credit', // Global
            'view_dealer_documents', 'manage_dealer_documents', // Global
            'view_dealer_salepoints', 'manage_dealer_salepoints', // Global
            'upload_assets', 'view_assets', // Can upload/view global assets (e.g. for products)
            'send_emails', 'generate_pdfs', // Utility
            'view_sales_analytics', 'view_product_analytics', 'view_dealer_analytics', 'view_revenue_forecast', // Global analytics
            'view_orders', 'create_orders', 'update_orders', 'delete_orders', // Global order management (soft delete)
            'view_tariffs', 'manage_tariffs',
            'view_companies', 'manage_companies',
            'view_sim_serials', 'manage_sim_serials',
            'view_serial_numbers', 'manage_serial_numbers',
            'view_activations', 'create_activations', 'update_activations', 'delete_activations',
            'view_carts', 'manage_carts',
        ],
        'ShopManager': [
            'Manage Shop', // Global shop management
            'upload_assets', 'view_assets', 'manage_assets', // Global asset management for products
        ...
        'DealerSales': [
            ...
            'view_dealers', 'view_dealer_billing', 'view_dealer_credit', 'view_dealer_documents', 'view_dealer_salepoints', 'view_dealer_contracts',
            'view_orders', 'view_workflows', 'view_assets', 'view_user_analytics', 'view_sales_analytics', 'view_product_analytics', 'view_dealer_analytics', 'view_activation_analytics', 'view_revenue_forecast',
            'view_tariffs', 'view_companies', 'view_sim_serials', 'view_serial_numbers', 'view_activations', 'view_carts',
        ...
        'DealerActivator': [
            ...
            'view_dealers', 'view_dealer_documents', 'view_dealer_salepoints', 'view_dealer_contracts',
            'view_orders', 'view_workflows', 'view_assets',
            'view_tariffs', 'view_companies', 'view_sim_serials', 'view_serial_numbers', 'view_activations', 'view_product_analytics', 'view_dealer_analytics', 'view_activation_analytics', // Analytics relevant to activations
        ...
        'DealerAccounts': [
            // Includes relevant DealerViewer permissions +
            'view_dealers', 'view_dealer_billing', 'view_dealer_credit', 'view_dealer_documents', 'view_dealer_salepoints', 'view_dealer_contracts',
            'view_orders', 'view_workflows', 'view_user_analytics', 'view_sales_analytics', 'view_dealer_analytics', 'view_revenue_forecast',
            'view_tariffs', 'view_companies', 'view_carts', // View tariffs/companies/carts related to orders/billing
        ...
        'DealerManager': [
            ...
            'view_dealers', 'update_dealers', 'delete_dealers', // Scoped Dealer management
            'view_dealer_billing', 'manage_dealer_billing', // Scoped
            'view_dealer_credit', 'manage_dealer_credit', // Scoped
            'view_dealer_documents', 'manage_dealer_documents', // Scoped
            'view_dealer_salepoints', 'manage_dealer_salepoints', // Scoped
            'view_dealer_contracts', 'manage_dealer_contracts', // Scoped
            'view_orders', 'create_orders', 'update_orders', 'delete_orders', // Scoped Order management
            'view_workflows', 'manage_workflows', // Scoped Workflow management
            'view_assets', 'upload_assets', // Scoped Asset management
            'view_user_analytics', 'view_sales_analytics', 'view_product_analytics', 'view_dealer_analytics', 'view_activation_analytics', 'view_revenue_forecast', // Scoped Analytics
            'view_tariffs', 'manage_tariffs', // Manage tariffs relevant to their dealer? (Global permission, needs thought) -> Let's keep as global manage, view as global
            'view_companies', 'manage_companies', // Manage companies? -> Let's keep as global
            'view_sim_serials', 'manage_sim_serials', // Manage Sim Serials relevant to dealer? -> Let's keep as global manage, view scoped
            'view_serial_numbers', 'manage_serial_numbers', // Manage Serial Numbers -> Let's keep as global manage, view scoped
            'view_activations', 'create_activations', 'update_activations', 'delete_activations', // Manage Activations -> Scoped
            'view_carts', 'manage_carts', // Manage Carts -> Scoped
        ],
        'User': [
    ...
    // Add permissions not explicitly listed in any role mapping but exist in permissionsData
    // This handles permissions like delete_* that might be covered by manage_* but weren't explicitly added to roles
    const allPermissionsNames = permissionsData.map(p => p.name);
    for (const roleName in rolesWithPermissions) {
        const assignedNames = rolesWithPermissions[roleName];
        // Add any permission name that exists in permissionsData but wasn't in the assigned list
        // This ensures all permissions are considered, even if some are only implicitly used (like delete_* under manage_*)
        // Or if you want a specific permission like delete_roles to be assigned separately.
        // For simplicity, we'll assume the explicit lists above are the source of truth for assignments.
        // If a permission like 'delete_roles' isn't in the Admin list above, it won't be assigned.
    }
    ...
    for (const roleName in rolesWithPermissions) {
        ...
        if (!role) {
            console.warn(`Skipping permission assignment for role "${roleName}": Role not found.`);
            continue;
        }
        ...
        if (permissionsToConnect.length !== permissionNamesForRole.length) {
            ...
            const missingPermNames = permissionNamesForRole.filter(name => !foundPermNames.includes(name));
            console.warn(`Warning: Some permissions for role "${roleName}" were not found during assignment: ${missingPermNames.join(', ')}`);
            // Continue assignment with the permissions found
        }

        console.log(`Assigning ${permissionsToConnect.length} permissions to role: "${role.name}"`);
        ...
        try {
            ...
            console.error(`Error assigning permissions for role "${roleName}":`, error);
        }
    }
    ...
    if (basicUserRole) {
        ...
        if (permissionsToConnect.length !== basicUserPermissions.length) {
            const foundPermNames = permissionsToConnect.map(p => p.name);
            const missingPermNames = basicUserPermissions.filter(name => !foundPermNames.includes(name));
            console.warn(`Warning: Some permissions for basic "User" role were not found during assignment: ${missingPermNames.join(', ')}`);
        }

        console.log(`Assigning ${permissionsToConnect.length} permissions to role: "${basicUserRole.name}"`);
        try {
            await prisma.role.update({
            ...
            console.error(`Error assigning permissions for basic "User" role:`, error);
        }
    }
